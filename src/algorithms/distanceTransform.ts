...
export function buildableSquares(room: string) {
    const result = new PathFinder.CostMatrix();
...
export function applyDistanceTransform(squares: CostMatrix): CostMatrix {
    ...
    let mid, right, bottomleft, bottom, bottomright;
...
export function testDistanceTransform(room: string) {
