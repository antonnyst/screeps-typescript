...
export class ScoutRole extends CreepRole {
    runRole() {
        ...
        if (this.creep.memory.roleData.target != undefined && this.creep.room.name != this.creep.memory.roleData.target) {
            ...
            if (this.creep.room.controller != undefined && (this.creep.room.controller.my || (this.creep.room.controller.reservation != undefined && this.creep.room.controller.reservation.username === Game.spawns[Object.keys(Game.spawns)[0]].owner.username)) && this.creep.room.controller.sign != undefined) {
